...
/*package*/ class Trouble_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Trouble_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticVertical_uzloje_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_uzloje_a");
  ...
  public Grid createStaticVertical_uzloje_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    grid.setColumnHeaders(0, 0, createStaticHeader_uzloje_a0a(editorContext, node));

    List<Grid> children = new ArrayList<Grid>(1);
    if (true) {
      children.add(createTableCell_uzloje_a0a(editorContext, node));
    }
  ...
  public HeaderGrid createStaticHeader_uzloje_a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Let's see, what are my troubles/difficulties?", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Let's see, what are my troubles/difficulties?"), cell);
    header.setLabel("Let's see, what are my troubles/difficulties?");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
  }
  public Grid createTableCell_uzloje_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.description$gj3V;
  ...
  private static final class PROPS {
    /*package*/ static final SProperty description$gj3V = MetaAdapterFactory.getProperty(0x38ae19b1540f43ecL, 0x83787a6f9a38ea5eL, 0x5b66c341f9f93f00L, 0x5b66c341f9f93f08L, "description");
  }

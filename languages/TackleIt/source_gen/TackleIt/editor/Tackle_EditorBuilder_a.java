...
/*package*/ class Tackle_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Tackle_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createTableCell_i1f2in_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_i1f2in_a");
  ...
  public Grid createTableCell_i1f2in_a0(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.description$gcIZ;
  ...
  private static final class PROPS {
    /*package*/ static final SProperty description$gcIZ = MetaAdapterFactory.getProperty(0x38ae19b1540f43ecL, 0x83787a6f9a38ea5eL, 0x5b66c341f9f93f01L, 0x5b66c341f9f93f02L, "description");
  }
